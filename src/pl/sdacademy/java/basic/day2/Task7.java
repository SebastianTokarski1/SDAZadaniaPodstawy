...
public class Task7 {
    ...
    // tutaj zakładamy dodatkowo że tekst zawierający same spacje nie jest prawidłowy
    // możecie sobie założyć że jest to poprawny tekst, wtedy procent spacji to będzie 100%
